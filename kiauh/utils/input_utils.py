...
def get_string_input(
    ...
    while True:
        ...
        if default is not None and _input == "":
            ...
            Logger.print_error(_("Input must not be empty!"))
        elif _pattern is not None and _pattern.match(_input):
            return _input
        elif _input.lower() in _exclude:
            Logger.print_error(_("This value is already in use/reserved."))
...
def get_selection_input(question: str, option_list: List | Dict, default=None) -> str:
    ...
    while True:
        ...
        Logger.print_error(_("Invalid option! Please select a valid option."), False)
